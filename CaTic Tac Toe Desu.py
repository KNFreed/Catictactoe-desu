...
def menu():
     def jeu():
          def multijouer():
               ...
               def jeua2():
                    ...
                    def quitterm():
                         ...
                         button10.destroy()
                         menu()
                    button10 = Button(window, image=retourj, command=quitterm, bd=0)
          ...
          button2.destroy()
          button3.destroy()
          button4 = Button(window, image=solo, command=toutseul, bd=0)
          button4.place(relx=0.5, rely=0.675, anchor="center")
          button5 = Button(window, image=retourj, command=retour, bd=0)
          button5.place(relx=0.5, rely=1.0, anchor=S)
          button6 = Button(window, image=multijoueur, command=multijouer, bd=0)
     ...
     def info():
          ...
          button2.destroy()
          button3.destroy()
          button4 = Button(window, image=me, bd=0)
          button4.place(relx=0.5, rely=0.0, anchor=N)
          button5 = Button(window, image=retourme, command=retour, bd=0)
          button5.place(relx=0.5, rely=1.0, anchor=S)
          PlaySound('./stuff/nya.wav', SND_FILENAME)
     button1 = Button(window, image=jouer, command=jeu, bd=0)
     button1.place(relx=0.5, rely=0.0, anchor=N)
     button2 = Button(window, image=quitter, command=window.destroy, bd=0)
     button2.place(relx=0.5, rely=1.0, anchor=S)
     button3 = Button(window, image=infoc, command=info, bd=0)
